...
public class ConnDB {
    ...
    private static String dbUrl = "jdbc:mysql://localhost:3306/db_9griddiary?user=root&password=111&useUnicode=true&characterEncoding=utf8";
    ...
    public static Connection getConnection() {
        ...
        try { // 连接数据库时可能发生异常因此需要捕捉该异常
            Class.forName("com.mysql.jdbc.Driver").newInstance(); // 装载数据库驱动
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_9griddiary?user=root&password=111&useUnicode=true&characterEncoding=utf8"); // 建立与数据库URL中定义的数据库的连接
        } catch (Exception ee) {
